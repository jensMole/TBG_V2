...
<html lang="nl">
    ...
    <body>
        ...
        <h1>Doorgaan ...</h1>
        <h3>(errorcode: 100 Doorgaan)</h3>
        <p style="text-align:center; font-size: 150%">
            Indien Problemen probeer het later nog eens of probeer Jens of Jasper te bereiken via <a target="_blank" href="https://www.youtube.com/c/TheBelgiumGamesTBG">YouTube</a> of via <a href="mailto:the.belgiumg@gmail.com">Mail</a>. 
        </p>
